...
const poiData = [ 
    ...
    { name: "51", type: "황", color: "#f1c40f", coords: mcToPx(677, 1433), mcX: 677, mcZ: 1433 }, { name: "52", type: "녹", color: "#2ecc71", coords: mcToPx(-762, -6601), mcX: -762, mcZ: -6601, order : 18, lineType : "solid" }, { name: "53", type: "녹", color: "#2ecc71", coords: mcToPx(2657, -5891), mcX: 2657, mcZ: -5891, order : 21, lineType : "solid" }, { name: "54", type: "녹", color: "#2ecc71", coords: mcToPx(2036, -3624), mcX: 2036, mcZ: -3624, order : 6, lineType : "solid" }, { name: "55", type: "청", color: "#3498db", coords: mcToPx(-4098, -55), mcX: -4098, mcZ: -55 }, { name: "56", type: "녹", color: "#2ecc71", coords: mcToPx(-2006, 127), mcX: -2006, mcZ: 127, order : 23, lineType : "solid" }, { name: "57", type: "녹", color: "#2ecc71", coords: mcToPx(-2264, -1571), mcX: -2264, mcZ: -1571, order : 13, lineType : "solid" }, { name: "58", type: "녹", color: "#2ecc71", coords: mcToPx(3885, -1415), mcX: 3885, mcZ: -1415, order : 3, lineType : "solid" }, { name: "59", type: "청", color: "#3498db", coords: mcToPx(-5054, -2598), mcX: -5054, mcZ: -2598 }, { name: "60", type: "적", color: "#e74c3c", coords: mcToPx(3323, 3939), mcX: 3323, mcZ: 3939 }, 
